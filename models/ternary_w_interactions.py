...
class ternary_seg_profile:
    ...
    def dX1_dt(self):
        ...
        excess_term_B[0] = mu_ex_B_x1[0] - mu_ex_B_x0
        excess_term_C[0] = mu_ex_C_x1[0] - mu_ex_C_x0
        excess_term_B[1] = mu_ex_B_x1[1] - mu_ex_B_x0
        excess_term_C[1] = mu_ex_C_x1[1] - mu_ex_C_x0
        
        
        excess_term_B[2] = mu_ex_B_x1[2] - mu_ex_B_x0
        excess_term_C[2] = mu_ex_C_x1[2] - mu_ex_C_x0
        excess_term_B[3] = mu_ex_B_x1[3] - mu_ex_B_x0
        excess_term_C[3] = mu_ex_C_x1[3] - mu_ex_C_x0
        excess_term_B[4] = mu_ex_B_x1[4] - mu_ex_B_x0
        excess_term_C[4] = mu_ex_C_x1[4] - mu_ex_C_x0
        
        Delta_G_ij_C = Delta_G_ij_C_0 + excess_term_C
        Delta_G_ij_B = Delta_G_ij_B_0 + excess_term_B
